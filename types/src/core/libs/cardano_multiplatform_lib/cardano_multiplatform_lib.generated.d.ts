...
export class TransactionBuilderConfigBuilder {
     ...
     * @returns {TransactionBuilderConfigBuilder}
     */
    min_fee_reference_scripts_base(min_fee_reference_scripts_base: number): TransactionBuilderConfigBuilder;
    /**
     * @param {number} min_fee_reference_scripts_range
     * @returns {TransactionBuilderConfigBuilder}
     */
    min_fee_reference_scripts_range(min_fee_reference_scripts_range: number): TransactionBuilderConfigBuilder;
    /**
     * @param {number} min_fee_reference_scripts_multiplier
     * @returns {TransactionBuilderConfigBuilder}
     */
    min_fee_reference_scripts_multiplier(min_fee_reference_scripts_multiplier: number): TransactionBuilderConfigBuilder;
    /**
